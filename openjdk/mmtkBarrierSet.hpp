...
public:
  ...
  /// Generic arraycopy pre-barrier. Called by fast-paths.
  static void object_reference_array_copy_pre_call(void* src, void* dst, size_t count, void* src_base, void* dst_base);
  ...
  /// Full arraycopy pre-barrier
  virtual void object_reference_array_copy_pre(oop* src, oop* dst, size_t count, oop src_base, oop dst_base) const {};
...
public:
  ...
  public:
    ...
    static bool oop_arraycopy_in_heap(arrayOop src_obj, size_t src_offset_in_bytes, T* src_raw,
      ...
      runtime()->object_reference_array_copy_pre((oop*) src, (oop*) dst, length, src_obj, dst_obj);
