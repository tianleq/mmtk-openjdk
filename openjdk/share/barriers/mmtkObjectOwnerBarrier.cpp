...
void MMTkObjectOwnerBarrierSetRuntime::object_reference_write_pre(oop src, oop* slot, oop target) const {
  ...
  //   // MMTkObjectOwnerBarrierSetRuntime::object_reference_write_pre_slow()((void*) src);
...
void MMTkObjectOwnerBarrierSetRuntime::object_reference_read_post(oop value) const {
#if MMTK_ENABLE_BARRIER_FASTPATH
  object_reference_read_slow_call((void*) value);
#else
  object_reference_read_slow_call((void*) value);
#endif
}
...
void MMTkObjectOwnerBarrierSetAssembler::object_reference_write_post(MacroAssembler* masm, DecoratorSet decorators, Address dst, Register val, Register tmp1, Register tmp2) const {
...
void MMTkObjectOwnerBarrierSetAssembler::arraycopy_epilogue(MacroAssembler* masm, DecoratorSet decorators, BasicType type, Register src, Register dst, Register count) {
...
void MMTkObjectOwnerBarrierSetC1::object_reference_write_post(LIRAccess& access, LIR_Opr src, LIR_Opr slot, LIR_Opr new_val) const {
...
void MMTkObjectOwnerBarrierSetC2::object_reference_write_post(GraphKit* kit, Node* src, Node* slot, Node* val) const {
