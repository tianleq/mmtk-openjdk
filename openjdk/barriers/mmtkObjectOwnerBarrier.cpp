...
void MMTkObjectOwnerBarrierSetAssembler::oop_store_at(MacroAssembler* masm, DecoratorSet decorators, BasicType type, Address dst, Register val, Register tmp1, Register tmp2) {
...
void MMTkObjectOwnerBarrierSetC1::record_modified_node(LIRAccess& access, LIR_Opr src, LIR_Opr slot, LIR_Opr new_val) {
  ...
  CodeStub* slow = new MMTkObjectOwnerBarrierStub(src, slot, new_val);
